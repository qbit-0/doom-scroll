...
const Select: FC<Props> = ({
    ...
    const highlightStyle = `flex-auto rounded-3xl border-2 p-1 text-sm font-bold text-neutral-50 outline-none drop-shadow-lg transition-all sm:p-2 sm:text-base border-neutral-50 ${bgColor} ${hoverBgColor}`;
